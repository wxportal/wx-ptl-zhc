...
public class WXAccountDBService {
	...
	public boolean isWXAccountExist(String column,String value){
		...
		list = (ArrayList<WXAccountBean>)dao.query("WXAccountBean", new String[]{column}, new String[]{value},0,0);
	 ...
	 * @return
	 */
	public boolean delWXAccountByValues(String WXAccountBean,String[] columns,String[] values){
	 ...
	 */
	public void updateWXAccountByValue(String WXAccountBean,String[] columns,String[] values,String whereCause){
	...
	/**
	 * 依据条件查询WXAccount结果集
	 * @param userid:-1表示查询全部的微信账号，page为0是不分页查询，page大于0时会进行分页查询
	 * @param columns
	 * @param values
	 * @return
	 */
