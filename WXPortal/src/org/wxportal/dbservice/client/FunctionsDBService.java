...
public class FunctionsDBService {
	...
	public boolean isFunctionsExist(String name){
		...
		list = (ArrayList<FunctionsBean>)dao.query("FunctionsBean", new String[] {"name"}, new String[] {name}, 0, 0);
	...
	/**
	 * 查询父节点下所有的子功能
	 * @param pFucntionsId:为""是查询所有的功能信息
	 * @return
	 */
	public ArrayList<FunctionsBean> queryFunctions(String pFucntionsId){
		if("".equals(pFucntionsId)){
			return dao.query("FunctionsBean", new String[]{}, new String[]{},0,0);
		}
		return dao.query("FunctionsBean", new String[]{"pFunctionId"}, new String[]{pFucntionsId},0,0);
	}
