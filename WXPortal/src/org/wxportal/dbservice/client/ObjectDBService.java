...
/**
 * 自定义回复详细类型相关(infoType)，主要包括：
 * text,music,image,link，news,function
...
public class ObjectDBService {
	 ...
	 * @return
	 */
	public boolean delByValues(Object object,String[] columns,String[] values,String infoType){
	 ...
	 */
	public void updateByValue(Object object,String[] columns,String[] values,String whereCause,String infoType){
