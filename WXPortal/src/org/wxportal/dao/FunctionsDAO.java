...
public class FunctionsDAO extends HibernateBasicMethod {
	 ...
	 * @param values
	 */
	public boolean delByValue(Object FunctionsBean,String[] columns,String[] values){
	 ...
	 * @param functions
	 */
	public void update(FunctionsBean functions){
	 ...
	 * @param whereCause
	 */
	public void updateByValue(Object FunctionsBean,String[] columns,String[] values,String whereCause){
	...
	public ArrayList<FunctionsBean> query(Object FunctionsBean,String[] columns,String[] values,int page,int pageSize){
		return (ArrayList<FunctionsBean>)super.query(FunctionsBean, columns, values,page,pageSize);
	}
}
