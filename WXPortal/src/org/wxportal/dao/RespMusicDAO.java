...
public class RespMusicDAO extends DAOFactory {
	 ...
	 */
	@Override
	public boolean delByValue(Object RespMusicBean, String[] columns,
			String[] values) {
	 ...
	 */
	@Override
	public boolean updateByValue(Object RespMusicBean, String[] columns,
	...
	public List querysByValue(String[] columns, String[] values,
		...
		return baseMethod.query("RespMusicBean", columns, values, page, pageSize);
	}

	@Override
	public List querys(int wxAccountId, int page, int pageSize) {
		String whereCause = " where wxAccountId = " + wxAccountId;
		return baseMethod.queryByCondition("RespMusicBean", whereCause, page,
				pageSize);
	}
