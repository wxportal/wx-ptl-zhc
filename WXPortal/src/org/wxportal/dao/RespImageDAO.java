...
public class RespImageDAO extends DAOFactory {
	 ...
	 */
	@Override
	public boolean delByValue(Object RespImageBean,String[] columns,String[] values){
	 ...
	 */
	@Override
	public void updateByValue(Object RespImageBean,String[] columns,String[] values,String whereCause){
	...
	public List querys(int wxAccountId, int page, int pageSize) {
		...
		return baseMethod.queryByCondition("RespImageBean", whereCause, page, pageSize);
	}
