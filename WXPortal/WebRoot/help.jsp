...
<body>
	<table border="1" cellspacing="0" cellpadding="0" width="100%">
		...
		<tr>
			<td height="20" valign="middle" width="50%"><span class="STYLE1">&nbsp;&nbsp;
					...
					&nbsp;<a href="server/exit.jsp?curPage=help" style="float: right;">安全退出&nbsp;&nbsp;</a> <%
						} else {
							//如果未登录
					%> 用户尚未登录 <%
						}
	...
	<form action="server/login.jsp" method="post">
		用户名：<input name="username" /> 密码：<input name="password"
			...
			type="hidden" name="curPage" value="help" /> <input
			type="button" onclick="window.location='register.jsp?curPage=help'" value="注册">
	</form>
