...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 %> 当前登录用户：<%=request.getSession().getAttribute("nickname")%> &nbsp;<a
						href="server/exit.jsp?curPage=unknownResp" style="float: right;">安全退出&nbsp;&nbsp;</a>
						<%
							} else {
								//如果未登录
						%> 用户尚未登录 <%
		...
		<form action="server/login.jsp" method="post">
			...
			<input type="hidden" name="curPage" value="unknownResp" />
			<input type="button"
				onclick="window.location='register.jsp?curPage=unknownResp'"
				value="注册"/>
		</form>
					...
					<table width="100%" cellpadding="10">
						...
						<tr>
							<td>
								<img src="images/menu_point.jpg" />
								&nbsp;
								<a href="newsResp.jsp?wxaccountid=<%=wxaccountid%>">自定义图文回复</a>
							</td>
						</tr>
						<tr>
							<td>
								<img src="images/menu_point.jpg" />
								&nbsp;
								<a href="unknownResp.jsp?wxaccountid=<%=wxaccountid%>"
					...
					<form
						...
						<table width="100%" style="height: 100%;" cellpadding="10px"
							...
							<tr>
								...
								<td>
									即用户发送内容的简略版本，如【A:天气】，此时用户发送A或者天气都能获取到天气信息，A称作标识
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<input name="unknownRespText" />
								</td>
								<td>
									当用户发送【天气】时，我们会将您配置的回复内容回给用户。
								</td>
							</tr>
							<tr>
