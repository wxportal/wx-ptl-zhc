...
<body>
	<table border="1" cellspacing="0" cellpadding="0" width="100%">
		...
		<tr>
			<td height="20" valign="middle" width="50%"><span class="STYLE1">&nbsp;&nbsp;
					...
					href="server/exit.jsp?curPage=3GDefine" style="float: right;">安全退出&nbsp;&nbsp;</a>
					<%
						} else {
							//如果未登录
					%> 用户尚未登录 <%
	...
	<form action="server/login.jsp" method="post">
		用户名：<input name="username" /> 密码：<input name="password"
			...
			type="hidden" name="curPage" value="3GDefine" /> <input
			type="button"
			onclick="window.location='register.jsp?curPage=3GDefine'" value="注册">
	</form>
	...
	<table cellpadding="10" cellspacing="0" border="1" width="100%">
		...
		<tr>
			<td width="20%" valign="top"><table width="100%"
					...
					<tr>
						<td><img src="images/menu_point.jpg" />&nbsp;<a
							href="3GDefine.jsp?wxaccountid=<%=wxaccountid %>" style="background-color: blue;color: white;">3G站设置</a>
						</td>
					</tr>
				</table></td>
