	...
	<table border="1" cellpadding="10" cellspacing="0" width="100%">
		<tr>
			...
			<td>
				...
				onclick="window.location='addWXaccount.jsp'" value="添加公众帐号"><br /><br />
				<%
					} else {
				%>
			...
			<table width="100%" border="1" cellpadding="10" cellspacing="0">
					...
					<tr>
						...
						<td><input type="button"
							onclick="window.location='editWXaccount.jsp?wxaccountid=1'" value="编辑"><input type="button"
							onclick="window.location='delWXaccount.jsp?wxaccountid=1'" value="删除"> <input type="button"
