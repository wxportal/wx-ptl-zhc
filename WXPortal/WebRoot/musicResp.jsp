...
<body>
	<table border="1" cellspacing="0" cellpadding="0" width="100%">
		...
		<tr>
			<td height="20" valign="middle" width="50%"><span class="STYLE1">&nbsp;&nbsp;
					...
					&nbsp;<a href="server/exit.jsp?curPage=musicResp" style="float: right;">安全退出&nbsp;&nbsp;</a> <%
						} else {
							//如果未登录
					%> 用户尚未登录 <%
						}
	...
	<form action="server/login.jsp" method="post">
		用户名：<input name="username" /> 密码：<input name="password"
			...
			type="hidden" name="curPage" value="musicResp" /> <input
			type="button" onclick="window.location='register.jsp?curPage=musicResp'" value="注册">
	</form>
	...
	<table cellpadding="10" cellspacing="0" border="1">
		...
		<tr>
			<td width="20%" valign="top"><table width="100%"
					...
					<tr>
						<td><img src="images/menu_point.jpg" />&nbsp;<a
							href="musicResp.jsp" style="background-color: blue;color: white;">自定义音乐回复</a>
						</td>
					</tr>
					<tr>
						<td><img src="images/menu_point.jpg" />&nbsp;<a
			...
			<td colspan="3" valign="top"><h3>自定义音乐回复</h3>
				...
				<table width="620px" style="height: 100%;text-align: center;"
					...
					<tr>
						...
						<td style="background-color: silver">音乐标题</td>
						<td style="background-color: silver">音乐链接</td>
						<td style="background-color: silver">音乐描述</td>
					</tr>
					<tr>
						<td>青花瓷</td>
						<td>好听青花瓷，周董精品</td>
						<td>http://cooosuper.oicp.net/qhs.mp3</td>
						<td>好听青花瓷，周董精品</td>
					</tr>
					<tr>
						<td>青花瓷</td>
