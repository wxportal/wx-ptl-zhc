...
<body>
	...
	<form action="server/login.jsp" method="post">
		用户名：<input name="username" /> 密码：<input name="password"
			...
			type="button" onclick="window.location='register.jsp?curPage=addWXaccount'" value="注册">
	</form>
			...
			<td>
				...
				<table width="620px" style="height: 100%;" cellpadding="10px"
					...
					<tr>
						...
						<td>此处token和中转接口以及腾讯平台必须一致，为保证你的资源不被他人盗用，可以自己将中转接口的toke值改为当前你设定的值!</td>
					</tr>
					...
					<tr>
						<td colspan="3" align="center"><button>保存</button></td>
					</tr>
				</table>
			</td>
		</tr>
